...
export default function Home() {
  ...
  // - Component for out button to sit in

  return (
    <div className="m-8">
      <section>
        <h1>My Cool Midterm Submission</h1>
        <button className="border-2 border-black p-2 border-radius-30">Fetch </button>
      </section>
      <section>Here is where I will display my data</section>
    </div>
  );
}
